...
try:
    ...
    print " "
    logger.info("========== Reading in Spectra ==========")
    ...
    with open(filename,'rb') as f:
        for line in f:
            ...
            if ( check == 5 ):
                ...
                logger.info("Ignored first {} lines of code because they were dumb.".format(ignore))
                break
    ...
    print " "
    logger.info("Run time for prep work: {} mins.".format(round((intermediate-start)/60.,2)))
    ...
    logger.info("Run time to correlation: {} mins.".format(round((intermediate-start)/60.,2)))
    ...
    for specie in species:
        ...
        print " "
        logger.info("========== {} Lines detected. Culling bad lines ==========".format(specie))
    ...
    for specie in species:
        ...
        f.write("--------------------------------------------------------------------------\n")
        f.write("Redshift         EW_limit         Power_Sigma\n")
