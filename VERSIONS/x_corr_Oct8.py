...
def line_ratio_check(line_redshifts, ion_spectrum1, ion_spectrum2,redshift):
...
# LINE RATIO CHECK
line_redshifts = line_ratio_check(line_redshifts,scaled_MgII2796,scaled_MgII2803,redshift)

# ASYMMETRY CHECK - Second arg is the ion spectrum you're looking at
line_redshifts = asymmetry_check(line_redshifts,scaled_MgII2796,redshift)
line_redshifts = asymmetry_check(line_redshifts,scaled_MgII2803,redshift)
