...
try:
    ...
    # EDIT: Define how close to the QSO redshift you want to be
    ...
    for specie in species:
        ...
        # EDIT: Comment out what you don't need, add your favorite lines below.
        if ( specie == 'MgII' ):
    ...
    # If there is no wavelength coverage available, delete the species so we do not loop over this transition
    ...
    for specie in species:
        ...
        # Line Ratio Check
        # EDIT: Add/remove transitions to check using function line_ratio_check
        if ( specie == 'MgII' ):
        ...
        for lines in line_redshifts[specie]:
            ...
            # EDIT: Pick which individual transitions you want to have the EW detection limit calculated for
            if ( specie == 'MgII' ):
